...
class AQGaugeWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Center(
      ...
      //     LinearBarPointer(
      //       value: aqvalue ?? 0.0, // Pastikan aqvalue memiliki nilai default jika null
      //       thickness: 20,
      //       edgeStyle: LinearEdgeStyle.bothFlat,
      //       color: _getPointerColor(aqvalue ?? 0.0), // Pastikan fungsi menerima nilai yang valid
      //       position: LinearElementPosition.outside, // Menambahkan posisi bar agar di dalam
      //     ),
      //   ],

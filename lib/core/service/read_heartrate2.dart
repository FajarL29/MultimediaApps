...
class HeartRateService2 {
  ...
  final StreamController<double> _sbpController =
      StreamController<double>.broadcast();
  final StreamController<double> _dbpController =
      StreamController<double>.broadcast();
  ...
  Stream<double> get sbpRateStream => _sbpController.stream;
  Stream<double> get dbpRateStream => _dbpController.stream;
    ...
    for (int i = 0; i < lines.length - 1; i++) {
      ...
      switch (check) {
        ...
        case 'BTemp':
          ...
          break;
        case 'ESBP':
          double? esbp = double.tryParse(line[1]);
          if (esbp != null) {
          ...
          break;
        case 'EDBP':
          double? edbp = double.tryParse(line[1]);
          if (edbp != null) {
